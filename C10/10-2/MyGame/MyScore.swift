...
class MyScore: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        // 4. button1 圖片
        let button1 = SKSpriteNode(imageNamed: "Scorebutton1.png")
        button1.zPosition = 3
        ...
        // 5. button2 圖片
        let button2 = SKSpriteNode(imageNamed: "Scorebutton2.png")
        button2.zPosition = 3
        ...
        // 9. bear1 圖片
        let bear1 = SKSpriteNode(imageNamed: "Game3bear1.png")
        bear1.zPosition = 1
        self.addChild(bear1)
