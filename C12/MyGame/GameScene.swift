...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        /* 讀取和設定音樂 */
        // 1. 背景音樂
        let fileURL:URL = Bundle.main.url(forResource: "song",withExtension: "mp3")!
        var error: NSError?
        do {
        ...
        // 2. beep 音效
        let fileURL2:URL = Bundle.main.url(forResource: "beep",withExtension: "mp3")!
        var error2: NSError?
        do {
        ...
        // 3. click 音效
        let fileURL3:URL = Bundle.main.url(forResource: "click",
                                           withExtension: "mp3")!
        var error3: NSError?
        do {
